...
- Applied AI engineering and AI-enabled knowledge work
- Agent systems, tool use, evaluation, and observability
- Python, structured data workflows, and AI analytics
...
- I build baselines and evaluation methods instead of judging AI systems by demos alone.
- I think about correctness, latency, cost, tool use, guardrails, failure behavior, and human oversight together.
- I document tradeoffs and make technical work legible to both technical and non-technical stakeholders.
- I care about whether AI actually improves work, not only whether a model can produce an impressive answer.

## Current stack and skills

Python · SQL · ClickHouse · AI agents · tool integration · evaluation · workflow automation · Tableau · Excel · Notion · Asana · generative AI systems

## Connect

- Website: [ajaneeigharo.com](https://ajaneeigharo.com/)
- LinkedIn: [linkedin.com/in/ajaneeigharo](https://www.linkedin.com/in/ajaneeigharo/)
- X: [@AjaneeIgharo](https://x.com/AjaneeIgharo)
